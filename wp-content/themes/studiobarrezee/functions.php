...
acf_add_local_field_group(array (
	...
	'fields' => array (
		...
		array (
			'key' => 'field_5a657c64811dc',
			'label' => 'Most Popular Title Two',
			'name' => 'most_popular_title_two',
			'type' => 'text',
			'value' => NULL,
			'instructions' => '',
			'required' => 0,
		...
		array (
			'key' => 'field_5a657d1f811e1',
			'label' => 'Most Popular Description Two',
			'name' => 'most_popular_description_two',
			'type' => 'text',
			'value' => NULL,
			'instructions' => '',
			'required' => 0,
		...
		array (
			'key' => 'field_5a657ca1811de',
			'label' => 'Most Popular Price Two',
			'name' => 'most_popular_price_two',
			'type' => 'text',
			'value' => NULL,
			'instructions' => '',
			'required' => 0,
		...
		array (
			'key' => 'field_5a657cc1811df',
			'label' => 'Most Popular Description Two',
			'name' => 'most_popular_single_line_description_two',
			'type' => 'textarea',
			'value' => NULL,
			'instructions' => '',
			'required' => 0,
		...
		array (
			'key' => 'field_5a657cdb811e0',
			'label' => 'Most Popular Asterisk Two',
			'name' => 'most_popular_asterisk_two',
			'type' => 'textarea',
			'value' => NULL,
			'instructions' => '',
			'required' => 0,
