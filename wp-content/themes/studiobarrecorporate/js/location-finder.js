...
function initMap() {
   ...
   var carmelvalley = {lat: 32.9619726, lng: -117.1563793};
...
*/
 ...
 function initMap() {
        var map = new google.maps.Map(document.getElementById('map'), {
          zoom: 10,
          center: {lat: 32.9619726, lng: -117.1563793},
          styles: [
          {
            elementType: 'geometry',
            stylers: [{color: '#f5f5f5'}]
...
        ]
      ...
      var beaches = [
        ['Carmel Valley', 32.9619726, -117.1563793, 4],
        ['Encinitas', 33.0488976,-117.2634934, 5],
        ['La Jolla', 32.8158358,-117.2727427, 5]
      ...
      function setMarkers(map) {
        ...
        var image = {
          url: 'http://studiobarre-demo.com/wp-content/themes/studiobarrecorporate/js/map/pin.png',
